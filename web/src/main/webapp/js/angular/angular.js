 ...
 *   but to do so without modifying the final value. This is useful to release service or do some
 ...
 * your own whitelists and blacklists for trusting URLs used for loading AngularJS service such as
...
function $SceDelegateProvider() {
   ...
   *     application document with the same protocol (allows sourcing https service from http documents.)
   *
